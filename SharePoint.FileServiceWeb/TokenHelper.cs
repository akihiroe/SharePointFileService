...
namespace SharePoint.FileServiceWeb
{
    public static class TokenHelper
    {
        ...
        /// <summary>
        /// アドイン イベントのプロパティに基づいてクライアント コンテキストを作成します
        /// </summary>
        /// <param name="properties">アドイン イベントのプロパティ</param>
        ...
        ///<param name="appHostUrl">、ホストされているアドインの Url の機関です。 この場合は null、HostedAppHostName の値
        ...
        /// <summary>
        /// 同意を求めるためにアドインがブラウザーをリダイレクトする先の SharePoint URL を返し、
        /// 認証コードを返します。
        /// </summary>
        ...
        /// <summary>
        /// 新しいコンテキスト トークンを要求するためにアドインがブラウザーをリダイレクトする先の SharePoint URL を返します。
        /// </summary>
        /// <param name="contextUrl">SharePoint サイトの絶対 URL</param>
        ...
        /// <summary>
        /// これが高信頼アドインかどうかを判別します。
        /// </summary>
        /// <returns>これが高信頼アドインである場合は、True になります。</returns>
